        ...
        primaryStage.setOnCloseRequest(new EventHandler<WindowEvent>() {
            ...
            public void handle(WindowEvent event) {
                ...
                if (result.get() == ButtonType.YES){
                    ...
                    System.out.println("Incasari cash: "+service.getTotalAmount(service.getPayments(), PaymentType.Cash));
                    System.out.println("Incasari card: "+service.getTotalAmount(service.getPayments(),PaymentType.Card));
